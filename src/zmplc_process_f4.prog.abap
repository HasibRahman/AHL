...
*     FIELD_TAB    =
      return_tab   = it_ret.
  IF sy-subrc = 0 ##FM_SUBRC_OK.""++ATC Fix By EY_SANTOSH(Pravas) On 25/08/2021
...
MODULE date_f4_20 INPUT.
 CALL FUNCTION 'F4_DATE'
    EXPORTING
      date_for_first_month         = gs_1004-ship_date
      display                      = ' '
*     FACTORY_CALENDAR_ID          = ' '
*     GREGORIAN_CALENDAR_FLAG      = ' '
*     HOLIDAY_CALENDAR_ID          = ' '
